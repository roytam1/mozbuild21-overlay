...
CALL "C:\Program Files (x86)\Microsoft Visual Studio\2019\Community\VC\Auxiliary\Build\vcvarsall.bat" amd64_x86 -vcvars_ver=14.16

set LIB=%LIB%;C:\Program Files (x86)\Microsoft Visual Studio\2019\Community\DIA SDK\lib
